...
namespace Opennlp.Tools.Util.Featuregen
{
    ...
    /// </summary>
    internal class BrownClusterTokenClassFeatureGeneratorFactory : GeneratorFactory.AbstractXmlFeatureGeneratorFactory, GeneratorFactory.XmlFeatureGeneratorFactory
    {
