...
{
    internal class DocumentBeginFeatureGeneratorFactory : GeneratorFactory.AbstractXmlFeatureGeneratorFactory, GeneratorFactory.XmlFeatureGeneratorFactory
    {
        public DocumentBeginFeatureGeneratorFactory() : base()
        {
        }
