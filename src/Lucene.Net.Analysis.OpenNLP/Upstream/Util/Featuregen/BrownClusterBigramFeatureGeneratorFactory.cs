...
namespace Opennlp.Tools.Util.Featuregen
{
    ...
    /// </summary>
    internal class BrownClusterBigramFeatureGeneratorFactory : GeneratorFactory.AbstractXmlFeatureGeneratorFactory, GeneratorFactory.XmlFeatureGeneratorFactory
    {
        public BrownClusterBigramFeatureGeneratorFactory() : base()
        {
        }
