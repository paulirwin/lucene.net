...
namespace Opennlp.Tools.Util.Featuregen
{
    ...
    internal class SuffixFeatureGeneratorFactory : GeneratorFactory.AbstractXmlFeatureGeneratorFactory, GeneratorFactory.XmlFeatureGeneratorFactory
    {
        ...
        public virtual AdaptiveFeatureGenerator Create(XmlElement generatorElement, FeatureGeneratorResourceProvider resourceManager)
        {
            ...
            {
                suffixLength = int.Parse(attribute);
            }
